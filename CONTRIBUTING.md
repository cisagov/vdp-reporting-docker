...
issue](https://github.com/cisagov/vdp-reporting-docker/issues) in this
...
request](https://github.com/cisagov/vdp-reporting-docker/pulls), you will
...
```console
cd vdp-reporting-docker
pyenv virtualenv <python_version_to_use> vdp-reporting-docker
pyenv local vdp-reporting-docker
